...
public class T14EsPduSender 
{
    ...
    public static final String DEFAULT_MULTICAST_GROUP="224.0.0.251"; //"239.1.2.3";
    public static final String UNICAST_IP="10.56.1.171";
    public static final String BROAD_CAST="10.56.1.255";
   // public static final String DEFAULT_UNICAST="10.4.140.73";
    /** Port we send on */
...
public static void main(String args[])
{
    ...
    double lat = 29.549034; 
    double lon = 46.618687;
    double alt = 0;
    ...
    try
    {
       ...
       // destinationIp = InetAddress.getByName(UNICAST_IP);
    	destinationIp = InetAddress.getByName(BROAD_CAST);
    ...
    String networkModeString = systemProperties.getProperty("network"); // unicast or multicast or broadcast
   ...
   // short force_id= espdu.getForceId();
