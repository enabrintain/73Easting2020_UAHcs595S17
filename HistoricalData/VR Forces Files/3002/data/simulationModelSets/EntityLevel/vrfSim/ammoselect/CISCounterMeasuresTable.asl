...
;; All rights reserved.
;;
;; $RCSfile: CISCounterMeasuresTable,v $ $Revision: 1.1 $ $State: Exp $
;;
;; Counter Measures Select Table for CIS automatic counter measures launcher
;; (for example only!)
;;
...
(counter-measures-select-table
   (ir-guided-sidewinder
      ...
      (ammo
        (cis-flare ;; these names need to match resource names
            (munition-type  8 2 222 2 1 0 0)
            (warhead  0)
         )
      )
   )
